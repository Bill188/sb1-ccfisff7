      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 max-w-4xl py-16">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">If you have any questions about these Terms of Service, please contact us at <a href="mailto:info@masterpropertycare.co.nz" className="text-accent-500 hover:underline">info@masterpropertycare.co.nz</a> or call us at 027 707 1288.</p>
          </section>
        </div>
      </main>
      <Footer />
